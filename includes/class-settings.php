...
class EGA_Settings {
    ...
    public static function render_page() {
        ...
        $excluded_roles = get_option('for_you_google_analytics_excluded_roles', array());
                        ...
                        <div class="ega-card">
                            <div class="ega-card-header">
                                <div class="ega-card-title-group">
                                    ...
                                    <div>
                                        <h2 class="ega-card-title"><?php esc_html_e('Role Exclusion', 'for-you-google-analytics'); ?></h2>
                                        <p class="ega-card-subtitle"><?php esc_html_e('Prevent specific logged-in roles, such as Administrators, from being tracked.', 'for-you-google-analytics'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="ega-card-body">
                                <?php foreach (get_editable_roles() as $role_slug => $role_info) : ?>
                                    <label style="display:block;margin-bottom:6px;">
                                        <input
                                            type="checkbox"
                                            name="for_you_google_analytics_excluded_roles[]"
                                ...
                                <?php endforeach; ?>
                                <p class="ega-helper-text">
                                    <?php esc_html_e('Logged-in users with any of the checked roles will not be tracked, and will not see the consent banner or contribute to event-tracking data.', 'for-you-google-analytics'); ?>
                                </p>
                            </div>
                        </div>
